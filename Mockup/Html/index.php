...
<div class="row">
    <section class="col-12 col-md-8">
        <h2 class="section-title">Events to come</h2>
            ...
            <div class="container-fluid">
                <nav class="event-footer row">
                    <a href="#" class="event-footer-item event-commentbtn col-4">
                        <div class="event-footer-item-icon">
                            <i class="fa fa-comment-o" aria-hidden="true"></i></div>
        ...
        <aside class="shop-content">
            <div class="widget">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 product">
                        <div class="product-image">
                            <img src="static/img/gallery/4.jpg" alt="SecondProduct" class="product2" />
                        </div>
                        <div class="product-desc">
                            <h4 class="product-title">
                                Item 2
